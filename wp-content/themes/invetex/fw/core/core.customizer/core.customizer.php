...
if ( !function_exists( 'invetex_core_customizer_theme_setup' ) ) {
	...
	function invetex_core_customizer_theme_setup() {
		...
		if ( is_admin() ) {
			...
			add_action('wp_ajax_nopriv_invetex_options_save',			'invetex_core_customizer_save_options');
			...
			add_action('wp_ajax_nopriv_invetex_options_scheme_delete',	'invetex_core_customizer_scheme_delete');

			// Ajax Copy color scheme Action handler
			add_action('wp_ajax_invetex_options_scheme_copy', 			'invetex_core_customizer_scheme_copy');
			add_action('wp_ajax_nopriv_invetex_options_scheme_copy',	'invetex_core_customizer_scheme_copy');
		}
...
if (!function_exists('invetex_core_customizer_load_scripts')) {
	function invetex_core_customizer_load_scripts() {
		if (file_exists(invetex_get_file_dir('core/core.customizer/core.customizer.css')))
			invetex_enqueue_style( 'invetex-core-customizer-style',	invetex_get_file_url('core/core.customizer/core.customizer.css'), array(), null);
		if (file_exists(invetex_get_file_dir('core/core.customizer/core.customizer.js')))
			invetex_enqueue_script( 'invetex-core-customizer-script', invetex_get_file_url('core/core.customizer/core.customizer.js'), array(), null );
	}
}
