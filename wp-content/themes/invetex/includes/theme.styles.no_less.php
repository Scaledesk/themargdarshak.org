...
if (!function_exists('invetex_customizer_wp_add_theme_fonts')) {
	function invetex_customizer_wp_add_theme_fonts($fonts) {
		if (invetex_substr($fonts['h1_font-family'], 0, 2) == '{{') {
			...
			$fonts['menu_height_1']			 = invetex_summ_css_value( invetex_summ_css_value( $fonts['menu_margin-top_value'],  $fonts['menu_margin-bottom_value'] ), ($fonts['menu_line-height_value'] - 0.2) );
