...
if ($post_data['post_edit_enable']) {
	...
	invetex_enqueue_style ( 'fontello-admin',        invetex_get_file_url('css/fontello-admin/css/fontello-admin.css'), array(), null);
	invetex_enqueue_style ( 'frontend-editor-style', invetex_get_file_url('js/core.editor/core.editor.css'), array(), null );
	invetex_enqueue_script( 'frontend-editor',       invetex_get_file_url('js/core.editor/core.editor.js'),  array(), null, true );
