...
if (!empty($post_data['post_video'])) {
	echo trim(invetex_get_video_frame($post_data['post_video'], $post_data['post_video_image'] ? $post_data['post_video_image'] : $post_data['post_thumb']));

} else if (!empty($post_data['post_audio'])) {
	if (invetex_get_custom_option('substitute_audio')=='no' || !invetex_in_shortcode_blogger(true))
		echo trim(invetex_get_audio_frame($post_data['post_audio'], $post_data['post_audio_image'] ? $post_data['post_audio_image'] : $post_data['post_thumb_url']));
	else
