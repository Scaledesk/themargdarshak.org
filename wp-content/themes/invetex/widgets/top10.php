...
class invetex_widget_top10 extends WP_Widget {
	...
	function __construct() {
		$widget_ops = array('classname' => 'widget_top10', 'description' => esc_html__('Top 10 posts by average reviews marks (by author and users)', 'invetex'));
		parent::__construct( 'invetex_widget_top10', esc_html__('Themerex - Top 10 Posts', 'invetex'), $widget_ops );
	...
	function form($instance) {
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('title_author')); ?>"><?php esc_html_e('Author rating tab title:', 'invetex'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('title_users')); ?>"><?php esc_html_e('Users rating tab title:', 'invetex'); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('show_counters')); ?>_2"><?php esc_html_e('As stars', 'invetex'); ?></label>
			...
			<label for="<?php echo esc_attr($this->get_field_id('show_counters')); ?>_1"><?php esc_html_e('As icon', 'invetex'); ?></label>
...
if (!function_exists('invetex_widget_top10_reg_shortcodes_vc')) {
	...
	function invetex_widget_top10_reg_shortcodes_vc() {
		...
		vc_map( array(
				...
				"name" => esc_html__("Widget Top10 Reviews", 'invetex'),
				"description" => wp_kses_data( __("Insert Top10 reviews list with thumbs and post's meta", 'invetex') ),
				...
				"params" => array(
					...
					array(
						...
						"heading" => esc_html__("Author's tab title", 'invetex'),
						"description" => wp_kses_data( __("Title for the tab with authors's reviews", 'invetex') ),
						"class" => "",
						"value" => "",
						"type" => "textfield"
					),
					array(
						...
						"heading" => esc_html__("User's tab title", 'invetex'),
						"description" => wp_kses_data( __("Title for the tab with authors's reviews", 'invetex') ),
						"class" => "",
						"value" => "",
						"type" => "textfield"
					...
					array(
						...
						"value" => array_flip(array(
							'2' => esc_html__('As stars', 'invetex'),
							'1' => esc_html__('As text', 'invetex'),
							'0' => esc_html__('Hide', 'invetex')
						)),
						"type" => "dropdown"
					),
