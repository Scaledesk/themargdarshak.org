...
function invetex_qrcode_update(widget) {
	invetex_qrcode_show(widget, {
...
function invetex_qrcode_show(widget, vc, opt) {
	if (opt.show_what==1) {
...
if (!window.invetex_set_color_picker) {
	function invetex_set_color_picker(id_picker) {
