...
if ( !function_exists( 'invetex_sc_video_reg_shortcodes' ) ) {
	...
	function invetex_sc_video_reg_shortcodes() {
		...
		invetex_sc_map("trx_video", array(
			"title" => esc_html__("Video", 'invetex'),
			"desc" => wp_kses_data( __("Insert video player", 'invetex') ),
			"decorate" => false,
			"container" => false,
			"params" => array(
				"url" => array(
					"title" => esc_html__("URL for video file", 'invetex'),
					"desc" => wp_kses_data( __("Select video from media library or paste URL for video file from other site", 'invetex') ),
					"readonly" => false,
					"value" => "",
					"type" => "media",
					"before" => array(
				...
				"ratio" => array(
					"title" => esc_html__("Ratio", 'invetex'),
					"desc" => wp_kses_data( __("Ratio of the video", 'invetex') ),
					"value" => "16:9",
					"type" => "checklist",
					"dir" => "horizontal",
					"options" => array(
						"16:9" => esc_html__("16:9", 'invetex'),
						"4:3" => esc_html__("4:3", 'invetex')
					)
				),
				"autoplay" => array(
					"title" => esc_html__("Autoplay video", 'invetex'),
					"desc" => wp_kses_data( __("Autoplay video on page load", 'invetex') ),
					"value" => "off",
					"type" => "switch",
				...
				"image" => array(
					...
					"desc" => wp_kses_data( __("Select or upload image or write URL from other site for video preview", 'invetex') ),
					"readonly" => false,
					"value" => "",
					"type" => "media"
				),
				"bg_image" => array(
					...
					"desc" => wp_kses_data( __("Select or upload image or write URL from other site for video background. Attention! If you use background image - specify paddings below from background margins to video block in percents!", 'invetex') ),
					"divider" => true,
					"readonly" => false,
					"value" => "",
					"type" => "media"
				...
				"bg_top" => array(
					"title" => esc_html__("Top offset", 'invetex'),
					"desc" => wp_kses_data( __("Top offset (padding) inside background image to video block (in percent). For example: 3%", 'invetex') ),
					"dependency" => array(
				...
				"bg_bottom" => array(
					"title" => esc_html__("Bottom offset", 'invetex'),
					"desc" => wp_kses_data( __("Bottom offset (padding) inside background image to video block (in percent). For example: 3%", 'invetex') ),
					"dependency" => array(
						'bg_image' => array('not_empty')
					),
					"value" => "",
				...
				"bg_left" => array(
					"title" => esc_html__("Left offset", 'invetex'),
					"desc" => wp_kses_data( __("Left offset (padding) inside background image to video block (in percent). For example: 20%", 'invetex') ),
					"dependency" => array(
						'bg_image' => array('not_empty')
					),
					"value" => "",
				...
				"bg_right" => array(
					"title" => esc_html__("Right offset", 'invetex'),
					"desc" => wp_kses_data( __("Right offset (padding) inside background image to video block (in percent). For example: 12%", 'invetex') ),
					"dependency" => array(
						'bg_image' => array('not_empty')
					),
					"value" => "",
...
if ( !function_exists( 'invetex_sc_video_reg_shortcodes_vc' ) ) {
	...
	function invetex_sc_video_reg_shortcodes_vc() {
		...
		vc_map( array(
			"base" => "trx_video",
			"name" => esc_html__("Video", 'invetex'),
			"description" => wp_kses_data( __("Insert video player", 'invetex') ),
			...
			"params" => array(
				array(
					...
					"description" => wp_kses_data( __("Paste URL for video file", 'invetex') ),
					"admin_label" => true,
					"class" => "",
					"value" => "",
					"type" => "textfield"
				...
				array(
					"param_name" => "ratio",
					"heading" => esc_html__("Ratio", 'invetex'),
					"description" => wp_kses_data( __("Select ratio for display video", 'invetex') ),
					"class" => "",
					"value" => array(
						esc_html__('16:9', 'invetex') => "16:9",
						esc_html__('4:3', 'invetex') => "4:3"
					),
					"type" => "dropdown"
				),
				array(
					"param_name" => "autoplay",
					"heading" => esc_html__("Autoplay video", 'invetex'),
					"description" => wp_kses_data( __("Autoplay video on page load", 'invetex') ),
					"admin_label" => true,
					"class" => "",
				...
				array(
					...
					"description" => wp_kses_data( __("Select or upload image or write URL from other site for video preview", 'invetex') ),
					"class" => "",
					"value" => "",
					"type" => "attach_image"
				),
				array(
					"param_name" => "bg_image",
					"heading" => esc_html__("Background image", 'invetex'),
					"description" => wp_kses_data( __("Select or upload image or write URL from other site for video background. Attention! If you use background image - specify paddings below from background margins to video block in percents!", 'invetex') ),
					"group" => esc_html__('Background', 'invetex'),
					"class" => "",
					"value" => "",
					"type" => "attach_image"
				),
				array(
					"param_name" => "bg_top",
					"heading" => esc_html__("Top offset", 'invetex'),
					"description" => wp_kses_data( __("Top offset (padding) from background image to video block (in percent). For example: 3%", 'invetex') ),
					"group" => esc_html__('Background', 'invetex'),
					"class" => "",
					"value" => "",
					"type" => "textfield"
				...
				array(
					...
					"heading" => esc_html__("Bottom offset", 'invetex'),
					"description" => wp_kses_data( __("Bottom offset (padding) from background image to video block (in percent). For example: 3%", 'invetex') ),
					"group" => esc_html__('Background', 'invetex'),
					"class" => "",
					"value" => "",
					"type" => "textfield"
				...
				array(
					"param_name" => "bg_left",
					"heading" => esc_html__("Left offset", 'invetex'),
					"description" => wp_kses_data( __("Left offset (padding) from background image to video block (in percent). For example: 20%", 'invetex') ),
					"group" => esc_html__('Background', 'invetex'),
					"class" => "",
					"value" => "",
					"type" => "textfield"
				...
				array(
					"param_name" => "bg_right",
					"heading" => esc_html__("Right offset", 'invetex'),
					"description" => wp_kses_data( __("Right offset (padding) from background image to video block (in percent). For example: 12%", 'invetex') ),
					"group" => esc_html__('Background', 'invetex'),
					"class" => "",
					"value" => "",
					"type" => "textfield"
